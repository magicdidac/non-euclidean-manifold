...
public class Portal : MonoBehaviour
{
    ...
    public Portal[] alsoVisiblePortals;
    ...
    public void Render()
    {
        ...
        /*foreach(Portal newPortal in alsoVisiblePortals)
        {

            if (CameraUtility.VisibleFromCamera(newPortal.screen, linkedPortal.portalCam))
            {
                Debug.Log(gameObject.name + " -- " + newPortal.gameObject.name);
                newPortal.Render(linkedPortal.portalCam);
            }
        }*/
